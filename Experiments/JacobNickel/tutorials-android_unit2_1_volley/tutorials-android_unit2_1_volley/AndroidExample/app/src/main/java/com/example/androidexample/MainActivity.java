...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button strBtn, jsonObjBtn, jsonArrBtn, imgBtn, rndBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rndBtn = findViewById(R.id.btnDifferentRequest);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.btnDifferentRequest) {
            startActivity(new Intent(MainActivity.this, newButton.class));
        }
    }
}